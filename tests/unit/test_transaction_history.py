...
class TestCompanyTransfersHistory:
    ...
    @pytest.mark.parametrize("initial_balance, incoming_list, outgoing_list, outgoing_express_list, expected_history", [
        (0.0, [], [], [], []),
        (100.0, [], [], [75.0], [-75.0, -5.0]),
        (100.0, [], [], [-75.0], []),
        (100.0, [], [], [175.0], []),
    ...
    def test_company_history(self, account, initial_balance, incoming_list, outgoing_list, outgoing_express_list, expected_history):
...
class TestPersonalTransfersHistory:
    ...
    def test_personal_history(self, account, initial_balance, incoming_list, outgoing_list, outgoing_express_list, expected_history):
        account.balance = initial_balance
        for transfer in incoming_list:
            account.incoming_transfer(transfer)
